...
class PieChart extends CustomPainter {
  PieChart({required this.timermin, required this.timersec, required this.totaltimer, required this.currenttimer});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    double arcAngle = 2 * pi * ( (currenttimer ~/ totaltimer - currenttimer) / totaltimer); // 호(arc)의 각도를 정함. 정해진 각도만큼만 그리도록 함.
